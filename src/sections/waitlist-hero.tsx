...
export function WaitlistHero({ visible }: WaitlistHeroProps) {
  ...
  return (
    <SectionShell id="home" className="safe-section !justify-center">
      <div
      ...
      <button
        ...
        className="scroll-indicator safe-bottom-offset absolute left-1/2 flex min-h-[44px] min-w-[44px] -translate-x-1/2 flex-col items-center justify-center gap-1 text-[#6b7494] transition active:text-[#ffe500]"
