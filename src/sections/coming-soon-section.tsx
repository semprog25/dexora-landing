...
function StoreBadge({
  ...
  return (
    <div
      className={`mx-auto flex max-w-sm items-center justify-center gap-3 rounded-xl border px-5 py-3 ${
        disabled
    ...
    >
      ...
      {disabled && (
        <span className="rounded-full bg-[#ffe500]/20 px-3 py-1 text-xs font-medium text-[#ffe500]">
          Soon
        </span>
      )}
    </div>
  ...
  return (
    <SectionShell index={sectionIndex} id="coming-soon">
      <div className="mx-auto max-w-xl">
        ...
        <h2 className="mb-6 text-3xl font-extrabold text-[#edf0ff] md:text-4xl">
          Launching on iOS &amp; Android
        </h2>
        <p className="mb-10 text-lg text-[#8892b0]">
