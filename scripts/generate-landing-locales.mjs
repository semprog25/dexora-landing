...
const LOCALE_OVERRIDES = {
  de: {
    ...
    hero: {
      ...
      headline3: "Assistent",
      copy: "Plane Jagden, verfolge deinen Living Dex, erhalte Raid- und PvP-Intelligenz und scanne Screenshots mit Trainer Vision — offline-first, in 13 Sprachen.",
  ...
  fr: {
    ...
    hero: {
      ...
      copy: "Planifiez vos chasses, suivez votre living dex, obtenez de l'intelligence Raid et PvP et scannez des captures avec Trainer Vision — offline-first, en 13 langues.",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  es: {
    ...
    hero: {
      ...
      copy: "Planifica cacerías, sigue tu living dex, obtén inteligencia de raids y PvP, y escanea capturas con Trainer Vision — offline-first, en 13 idiomas.",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  it: {
    ...
    hero: {
      ...
      copy: "Pianifica cacce, traccia il tuo living dex, ottieni intelligence raid e PvP e scansiona screenshot con Trainer Vision — offline-first, in 13 lingue.",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  pt: {
    ...
    hero: {
      ...
      copy: "Planeje caçadas, acompanhe seu living dex, obtenha inteligência de raid e PvP e escaneie capturas com Trainer Vision — offline-first, em 13 idiomas.",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  ru: {
    ...
    hero: {
      ...
      headline2: "Pokémon GO",
      headline3: "помощник",
      copy: "Планируйте охоты, отслеживайте свой living dex, получайте аналитику рейдов и PvP и сканируйте скриншоты с Trainer Vision — offline-first, на 13 языках.",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  ja: {
    ...
    hero: {
      ...
      headline2: "Pokémon GO",
      headline3: "アシスタント",
      copy: "捕獲計画、living dex 管理、レイドと PvP の情報取得、Trainer Vision によるスクリーンショット解析まで。offline-first で 13 言語対応。",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  ko: {
    ...
    hero: {
      ...
      headline2: "Pokémon GO",
      headline3: "도우미",
      copy: "사냥 계획, living dex 추적, 레이드 & PvP 인텔리전스, Trainer Vision 스크린샷 스캔까지 — offline-first, 13개 언어 지원.",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  "zh-Hans": {
    ...
    hero: {
      ...
      headline2: "Pokémon GO",
      headline3: "助手",
      copy: "规划狩猎、追踪 living dex、获取 Raid 与 PvP 情报，并用 Trainer Vision 扫描截图——offline-first，支持 13 种语言。",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  "zh-Hant": {
    ...
    hero: {
      ...
      headline2: "Pokémon GO",
      headline3: "助手",
      copy: "規劃狩獵、追蹤 living dex、取得 Raid 與 PvP 情報，並使用 Trainer Vision 掃描截圖——offline-first，支援 13 種語言。",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  ar: {
    ...
    hero: {
      ...
      headline2: "Pokémon GO",
      headline3: "",
      copy: "خطط لعمليات الصيد، وتتبع living dex، واحصل على ذكاء Raid وPvP، وامسح لقطات الشاشة عبر Trainer Vision — يعمل offline-first وبـ13 لغة.",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
  ...
  he: {
    ...
    hero: {
      ...
      headline2: "Pokémon GO",
      headline3: "",
      copy: "תכנן ציידים, עקוב אחרי living dex, קבל מודיעין Raid ו-PvP, וסרוק צילומי מסך עם Trainer Vision — בגישת offline-first וב-13 שפות.",
      benefitDaily: "Daily GO Assistant",
      benefitCollection: "Collection Tracking",
      benefitBattle: "Battle Intelligence",
